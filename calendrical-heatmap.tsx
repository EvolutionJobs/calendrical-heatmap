...
/** Represent a point in a calendrical heatmap. */
export interface HeatMapPoint {

    /** Get or set the date formatted "yyyy-mm-dd". */
    date: string;

    /** Get or set the total to apply to the date. */
    total: number;
}
...
/** Display a calendar heatmap with streaks for consecutive days */
export class CalendricalHeatmap extends WithVdom(Polymer.Element) {
    ...
    private displayContent(days: HeatmapDay[], showStreak = false, failStreak = false, totalText: string = ''): void {
        ...
        // Render the SVG and wrapping HTML
        super.render(htmlContent);
    }
